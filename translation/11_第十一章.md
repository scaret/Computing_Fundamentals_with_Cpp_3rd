...
3. Iteration is prevalent; sets are not. Th e iterator functions were shown to make you aware that this pattern is frequently used, while showing one way to access all elements of a collection. The syntax and method names are different in the C++ Standard Template Library. Sets are not used as often as other collections such as lists, stacks, and maps.

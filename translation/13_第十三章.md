...
Reference to individual elements in a vector of vectors requires two subscripts, one for the row and another for the column. Because of this, another name for this data structure is the *twodimensional (2D) array*.
